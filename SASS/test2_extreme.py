...
# python /home/local/ASURITE/yzeng88/fedSASS/SASS/test2_FedAvg.py --num_clients 100 --global_rounds 10 --local_epochs 1 --dist dirichlet --alpha2 0.2
# python /home/local/ASURITE/yzeng88/fedSASS/SASS/test2_extreme.py --num_clients 10 --global_rounds 50 --local_epochs 10 --dist extreme
...
def main():
    ...
    out_dir = f"fedavg_EXTREME_{args.dist}_{args.num_clients}clients_{args.global_rounds}rounds"
