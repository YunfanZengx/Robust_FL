...
# python /home/local/ASURITE/yzeng88/fedSASS/SASS/fedGM_case_experiment_test.py --num_clients 5 --global_rounds 50 --local_epochs 1 --dist case1
...
"""
# python /home/local/ASURITE/yzeng88/fedSASS/SASS/fedGM_case_experiment_test.py --num_clients 5 --global_rounds 50 --local_epochs 1 --dist case2
...
def extreme_noniid_partition(train_dataset, num_clients, seed=42, output_path=None):
    """
    Assign exactly ONE distinct class to each client (client i only gets samples from class_i).
    """
    np.random.seed(seed)
