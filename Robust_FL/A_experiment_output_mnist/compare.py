...
For each experiment, we produce multiple pages in the output PDF:

  Page A: Test Loss vs. NN Pass subplots  
    - For experiments 1 and 2 the original two‐row layout is used for experiment 1,  
      while for experiments 2–4 the four algorithms are compared:
  ...
  Page B: Server Accuracy vs. Global Round  
    ...
    - For experiments 2, 3, and 4 all four algorithms are displayed.

For experiments 2, 3, and 4 the loss.txt file now contains five columns:
  ClientID   NNPass_Train   TrainLoss   NNPass_Test   TestLoss  
An extra page is produced for these experiments that plots Training Loss vs. NN Passes.

Additionally, for experiments 2, 3, and 4 we add a Page 3 that includes the 
lr_per_client_per_global_round_log.png file from the FedGM_SASS and FedAvg_SASS folders.

All figures are combined into a multi‐page PDF:
  /home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/compare_all_experiments.pdf
"""
...
###############################################################################
# Experiment directories (using A_experiment_output_mnist)
###############################################################################
# Experiment 1: case1
fedgm_sass_dir_exp1 = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedgm_sass_case1_5clients_50rounds"
fedgm_sgd_dir_exp1  = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedgm_sgd_case1_5clients_50rounds"
fedavg_dir_exp1     = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedavg_sass_case1_5clients_50rounds"

# Experiment 2: dirichlet non-iid (4 algorithms)
fedgm_sass_dir_exp2 = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedgm_sass_dirichlet_5clients_50rounds"
fedgm_sgd_dir_exp2  = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedgm_sgd_dirichlet_5clients_50rounds"
fedavg_sass_dir_exp2 = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedavg_sass_dirichlet_5clients_50rounds"
fedavg_sgd_dir_exp2  = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedavg_sgd_dirichlet_5clients_50rounds"

# Experiment 3: case2 (4 algorithms)
fedgm_sass_dir_exp3 = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedgm_sass_case2_5clients_50rounds"  # FedGM_SASS
fedgm_sgd_dir_exp3  = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedgm_sgd_case2_5clients_50rounds"   # FedGM_SGD
fedavg_sass_dir_exp3 = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedavg_sass_case2_5clients_50rounds"  # FedAvg_SASS
fedavg_sgd_dir_exp3  = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedavg_sgd_case2_5clients_50rounds"   # FedAvg_SGD

# Experiment 4: case3 (4 algorithms; note: in case3 only clients 0-2 have mislabeling)
fedgm_sass_dir_exp4 = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedgm_sass_case3_5clients_50rounds"
fedgm_sgd_dir_exp4  = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedgm_sgd_case3_5clients_50rounds"
fedavg_sass_dir_exp4 = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedavg_sass_case3_5clients_50rounds"
fedavg_sgd_dir_exp4  = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/fedavg_sgd_case3_5clients_50rounds"
...
###############################################################################
# 3) Plot: Test Loss vs. NN Passes for Experiment 3/4 (single-row layout)
###############################################################################
def create_loss_figure_exp3(exp_title, gm_sass_dir, gm_sgd_dir, avg_sass_dir, avg_sgd_dir):
    ...
    # For test loss, we use the second dictionary returned by read_loss_file
...
###############################################################################
# 3a) Plot: Training Loss vs. NN Passes for Experiments 3 and 4 (single-row layout)
###############################################################################
...
def create_accuracy_figure(exp_title, sass_dir, sgd_dir, fedavg_dir):
    """
    Creates a figure for server accuracy vs global round for experiments 1/2.
    The final accuracy numbers are displayed in a dedicated area above the main plot.
    (This function uses three directories; for four algorithms use create_accuracy_figure_exp3.)
    """
...
###############################################################################
def main():
    output_pdf = "/home/local/ASURITE/yzeng88/fedSASS/A_experiment_output_mnist/compare_all_experiments.pdf"
    pp = PdfPages(output_pdf)

    # Experiment 1: case1 (no extra training loss page because loss.txt has only 3 columns)
    exp1_title = "Experiment 1: case1"
    # Page A: Test Loss vs NN Passes
    fig1 = create_loss_figure_exp3(exp_title=exp1_title,
                                   gm_sass_dir=fedgm_sass_dir_exp1,
                                   gm_sgd_dir=fedgm_sgd_dir_exp1,
                                   avg_sass_dir=fedavg_dir_exp1,
                                   avg_sgd_dir=fedavg_dir_exp1)
    pp.savefig(fig1)
    plt.close(fig1)
    ...
    # Page B: Accuracy vs Global Round (4 algorithms)
