...
# 2) try use CIFAR-10
# python /home/local/ASURITE/yzeng88/fedSASS/SASS/test2_extreme_FedGM.py --num_clients 10 --global_rounds 50 --local_epochs 10 --dist extreme
...
def main():
    ...
    parser.add_argument("--dist", type=str, default="iid",
                        choices=["iid", "class", "dirichlet","extreme"], help="data distribution")
    ...
    out_dir = f"fedgm_EXTREME_{args.dist}_{args.num_clients}clients_{args.global_rounds}rounds"
