...
# case 3
# python /home/local/ASURITE/yzeng88/Robust_FL/experiment.py --dataset cifar10 --num_clients 5 --global_rounds 5 --local_epochs 1 --dist case3 --agg_method gm --local_opt sgd
